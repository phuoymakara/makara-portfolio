  ...
  return (
    ...
    >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          >
            ...
            <p className="text-xl text-gray-700 dark:text-gray-300 leading-relaxed">
              My expertise extends to modern frameworks like Next.js and state management tools like Redux. I am
      ...
      <div className="absolute bottom-0 right-0 w-64 h-64 -mb-32 -mr-32 opacity-20">
        {/* <Image className="" src="/placeholder.svg?height=256&width=256" alt="Decorative background" width={256} height={256} /> */}
      </div>
    </section>
  )
}
