  ...
  const experiences = [
    {
      ...
      responsibilities: [
        "Developing custom web applications for ministry clients",
        "Building responsive and scalable frontend interfaces with ReactJS, NextJS, VueJS, NuxtJS",
    ...
    },
    {
      ...
      role: "Web Developer",
      responsibilities: [
        "Developed and customized CMS-based websites",
        "Designed and implemented RESTful APIs",
        "Created responsive interfaces with React.js and Redux",
        "Implemented secure authentication websites",
