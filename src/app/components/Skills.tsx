...
const skills = [
  {
    ...
    tech: "React.js, Next.js, Vue.js, Nuxt.js",
    description:
  ...
  },
  {
    ...
    tech: "Node.js, Express, Fastify, PHP, Laravel",
  ...
  },
  {
    ...
    tech: "MongoDB, Mongoose, MySQL, MariaDB",
  ...
  },
  {
    icon: Layout,
    name: "UI/UX Design",
    tech: "Tailwind CSS, Shadcn UI, Ant Design, Material UI",
