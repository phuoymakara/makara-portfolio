    ...
    >
      ...
      <div className="container mx-auto px-6 pt-32 pb-20 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 py-4  bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400">
              Makara Phuoy
            </h1>
            ...
            <div className="flex justify-center lg:justify-start space-x-4 mb-8">
              <a
                target="_blank"
                href="https://github.com/phuoymakara/"
              ...
              <a
                target="_blank"
                href="https://www.linkedin.com/in/phuoy-makara-b93969238/"
                className="p-3 rounded-full bg-white/80 hover:bg-white dark:bg-gray-800/80 dark:hover:bg-gray-800 transition-colors duration-300 shadow-lg hover:shadow-xl"
          ...
          >
            <div className="relative w-72 h-72 md:w-96 md:h-96 mx-auto">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-400 to-purple-400 dark:from-blue-600 dark:to-purple-600 rounded-3xl transform rotate-6 opacity-50">
              <Image
                  src="https://res.cloudinary.com/drosy6q2y/image/upload/v1739154980/photo_2024-07-02_14-55-18_ojc0as.jpg"
                  alt="Makara Phuoy"
                  fill
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-purple-400 to-blue-400 dark:from-purple-600 dark:to-blue-600 rounded-3xl transform -rotate-6 opacity-80">
              <Image
                  src="https://res.cloudinary.com/drosy6q2y/image/upload/v1739154980/photo_2024-07-02_14-55-18_ojc0as.jpg"
                  alt="Makara Phuoy"
                  fill
